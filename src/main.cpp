...
void loop() { 
  ...
  sensorValue0 = map(analogRead(sensorPin0),0,1023,0,253);
  ...
  ADCFilter.Filter(sensorValue0);
  ADCFilter.Filter(sensorValue1);
  ADCFilter.Filter(sensorValue2);
...
//   readings0[readIndex0] = sensorValue0;
...
// //////////////////////////////////////////
  ...
  fill_gradient_HSV(leds, startPos, startColor, 4, endColor);
  fill_gradient_HSV(leds, endPos, startColor, 5, endColor);
  FastLED.show();
  delay(25);
